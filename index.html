          ...
          <div class="auth-card">
            ...
            <div class="demo-accounts">
              ...
              <div class="demo-buttons">
                <button class="demo-btn admin-btn">Admin</button>
                <span class="demo-credentials">admin / admin123</span>
              </div>
              <div class="demo-buttons">
                <button class="demo-btn visitor-btn">Visiteur</button>
                <span class="demo-credentials">visiteur / visiteur</span>
              </div>
            </div>
            ...
            <form id="login-form" class="auth-form">
              ...
              <button type="submit" class="btn btn-primary">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="accuille-user.html">Se connecter </a>
              </button>
          ...
          <div class="auth-card">
            ...
            <form id="register-form" class="auth-form">
              ...
              <button type="submit" class="btn btn-primary">
                ...
                <a href="index.html">Créer mon compte </a>
              </button>
