    ...
    <table class="table table-bordered table-striped annonces-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Activer/Désactiver -->
                    <form action="{{ route('annonce.toggle', $annonce->id) }}" method="POST" style="display:inline; margin: 20px;">
                        @csrf
                        @method('PATCH')
                    ...
                    <!-- Supprimer -->
                    <form action="{{ route('annonce.destroy', $annonce->id) }}" method="POST" style="display:inline; margin: 20px;" onsubmit="return confirm('Voulez-vous vraiment supprimer cette annonce ?');">
                        @csrf
                        @method('DELETE')
